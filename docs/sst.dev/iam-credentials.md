...
<details><summary><strong>Copy IAM Policy</strong></summary>
...
The permissions that SST needs to deploy the resources in your app depend on what you have in your app.
